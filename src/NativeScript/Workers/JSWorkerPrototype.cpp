...
static EncodedJSValue jsWorkerOnmessage(ExecState* state, JSObject* slotBase, EncodedJSValue thisValue, PropertyName) {
    // TODO: Provide implemention
    return JSValue::encode(jsNull());
}

static void setJSWorkerOnmessage(ExecState* state, JSObject* baseObject, EncodedJSValue thisValue, EncodedJSValue encodedValue) {
    // TODO: Provide implemention
}

static EncodedJSValue jsWorkerOnerror(ExecState* state, JSObject* slotBase, EncodedJSValue thisValue, PropertyName) {
    // TODO: Provide implemention
    return JSValue::encode(jsNull());
}

static void setJSWorkerOnerror(ExecState* state, JSObject* baseObject, EncodedJSValue thisValue, EncodedJSValue encodedValue) {
    // TODO: Provide implemention
}

static EncodedJSValue JSC_HOST_CALL jsWorkerProtoFuncPostMessage(ExecState* state) {
...
static const HashTableValue JSWorkerPrototypeTableValues[] = {
    ...
    { "postMessage", JSC::Function, NoIntrinsic, { (intptr_t) static_cast<NativeFunction>(jsWorkerProtoFuncPostMessage), (intptr_t)(1) } },
    { "terminate", JSC::Function, NoIntrinsic, { (intptr_t) static_cast<NativeFunction>(jsWorkerProtoFuncTerminate), (intptr_t)(0) } },
};
